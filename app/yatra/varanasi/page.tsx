        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="font-alice text-base md:text-lg space-y-4">
              ...
              <p>
                Our carefully crafted Varanasi journey offers you an authentic experience of this holy city, 
      ...
      <section className="py-16 bg-secondary/30 relative">
        <div className="container mx-auto px-4">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                <div className="font-alice space-y-4">
                  <p>
                    <strong>Arrival:</strong> Arrive in the timeless city of light and settle into a heritage stay along the sacred ghats.
                  </p>
                  <p>
                    <strong>Evening:</strong> As dusk approaches, witness the majestic Ganga Aarti at Dashashwamedh Ghat - a celestial spectacle where countless lamps, resonant chants and rhythmic drums transform the river into a flowing altar of devotion.
                  </p>
                </div>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="bg-primary text-white p-4">
                <h3 className="font-cinzel text-2xl font-bold">Day 2: Sunrise & Temple Circuit</h3>
              </div>
              <div className="p-6">
                <div className="font-alice space-y-4">
                  <p>
                    <strong>Early Morning:</strong> Awaken with the first rays of dawn and embark on a sunrise boat ride along the Ganga, watching the ancient ghats bathed in golden light.
                  </p>
                  <p>
                    <strong>Morning:</strong> Seek blessings at the revered Kashi Vishwanath Temple, honor the Divine Mother at Annapurna Mandir and reflect on the cycle of life and eternity at Manikarnika Ghat.
                  </p>
                  <p>
                    <strong>Afternoon:</strong> Meander through the old lanes, savoring stories steeped in chai and kachoris, before concluding with a reflective Bhagavad Gita session.
                  </p>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="bg-primary text-white p-4">
                <h3 className="font-cinzel text-2xl font-bold">Day 3: Sarnath & Farewell</h3>
              </div>
              <div className="p-6">
                <div className="font-alice space-y-4">
                  <p>
                  ...
                  <p>
                    <strong>Evening:</strong> Return for departure, carrying the blessings of both Shiva and Buddha.
                  </p>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-[1.02]">
              ...
              <div className="p-6">
                <h3 className="font-cinzel text-primary text-xl font-bold mb-2">Kashi Vishwanath Temple</h3>
                <p className="font-alice">
                  One of the most famous Hindu temples dedicated to Lord Shiva, believed to be the place where the light of Shiva shines eternally.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-[1.02]">
              ...
              <div className="p-6">
                <h3 className="font-cinzel text-primary text-xl font-bold mb-2">Dashashwamedh Ghat</h3>
                <p className="font-alice">
                  The main ghat in Varanasi, known for its spectacular Ganga Aarti ceremony that takes place every evening at sunset.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-[1.02]">
              ...
              <div className="p-6">
                <h3 className="font-cinzel text-primary text-xl font-bold mb-2">Sarnath</h3>
                <p className="font-alice">
                  The place where Buddha gave his first sermon after attaining enlightenment, marked by the famous Dhamek Stupa and Ashoka Pillar.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <ul className="font-alice list-disc pl-5 space-y-2">
                    <li>Immerse in the sacred Rudrabhishek at Kashi Vishwanath</li>
      ...
      <section className="py-16 relative">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="font-alice text-lg max-w-2xl mx-auto mb-8">
            Experience the timeless city of Varanasi with our carefully curated spiritual journey. 
            Connect with ancient traditions, immerse in sacred rituals, and transform your inner self.
          </p>
